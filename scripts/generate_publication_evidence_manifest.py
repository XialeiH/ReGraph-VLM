...
def main() -> int:
    ...
    lines = [
        ...
        "| Implementation reproducibility | Table `tab:implementation_details` | `manuscript_publication_claims_audit.csv` | loss, normalization, adjacency construction, architecture, optimizer, folds, and seeds are audited |",
