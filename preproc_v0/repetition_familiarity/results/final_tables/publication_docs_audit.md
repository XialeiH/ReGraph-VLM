...
| anonymous bundle manifest documented | ready | README, BUILD, REPRODUCIBILITY, and ANONYMIZATION document the per-file bundle manifest verifier and archive smoke test |
