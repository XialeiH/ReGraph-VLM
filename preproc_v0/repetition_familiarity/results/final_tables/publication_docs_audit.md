...
| anonymous bundle manifest documented | ready | README, BUILD, REPRODUCIBILITY, and ANONYMIZATION document the per-file bundle manifest verifier, archive smoke test, and extracted-bundle preflight |
