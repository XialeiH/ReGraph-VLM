...
| ROI-token control table | ready | table_roi_token_controls.csv: 5 rows |
...
| low-shot calibration table | ready | table_lowshot_calibration.csv: 5 rows, support n=120, expected at least 120 |
| external visual-ROI smoke table | ready | table_external_visual_roi_smoke.csv: 8 rows, support n=150, expected at least 100 |
| gate confound table | ready | table_gate_confound.csv: 3 rows |
...
| LAION trial-wise external validation LaTeX rows | ready | laion_fmri_visual_roi_latex.txt: 4 lines |
