...
Status counts: {'ready': 55}

| Item | Status | Evidence |
| --- | --- | --- |
| manuscript exists | ready | reports/neurips_report/may30.tex: 873 lines |
...
| implementation detail coverage | ready | 11 reproducibility detail groups present |
...
| adjacency contribution framing | ready | adjacency contribution framed as non-primary; fixed ROI-token/gated-readout claim present |
...
| TeX math dollar balance | ready | single=808, double=0 |
| table environment balance | ready | begin=22, end=22 |
| figure environment balance | ready | begin=5, end=5 |
| equation environment balance | ready | begin=8, end=8 |
| tabular environment balance | ready | begin=20, end=20 |
| tabularx environment balance | ready | begin=2, end=2 |
| LaTeX environment nesting | ready | 114 begin/end tokens nested correctly |
