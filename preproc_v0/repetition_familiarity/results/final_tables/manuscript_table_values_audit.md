...
| --- | --- | --- |
| table audit coverage | ready | 19 artifact-backed tables, 3 manual tables classified |
| table caption reporting | ready | 22 table captions declare reporting basis |
...
| tab:implementation_details parameter counts | ready | 5 parameter-count fragments match model_parameter_counts.csv |
| tab:laion_external_pairwise | ready | 20 numeric fragments match laion_fmri_visual_roi_pairwise_tests.csv |
...
| tab:edge_bias_followup | ready | 24 numeric fragments match rows in table_edge_bias_followup.csv |
| tab:single_ref_matched | ready | 42 numeric fragments match rows in single_ref_matched_summary.csv |
