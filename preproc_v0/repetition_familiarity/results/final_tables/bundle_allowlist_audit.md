...
| exact allowlist nonempty | ready | 122 exact paths |
| publication artifact allowlist nonempty | ready | 68 publication artifact paths |
...
| required audit scripts allowlisted | ready | 16 required paths present |
| required generated audits allowlisted | ready | 16 required paths present |
| publication artifacts included by exact allowlist | ready | 68 publication artifacts included |
...
| no forbidden bundle path classes | ready | no Git metadata, archives, run logs, or dist paths allowlisted |
