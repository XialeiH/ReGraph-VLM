...
| `preproc_v0/repetition_familiarity/results/final_tables/publication_artifact_provenance_audit.csv` | present | ready=31 |
| `preproc_v0/repetition_familiarity/results/final_tables/manuscript_publication_claims_audit.csv` | present | ready=55 |
| `preproc_v0/repetition_familiarity/results/final_tables/publication_docs_audit.csv` | present | ready=42 |
